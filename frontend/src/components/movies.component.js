      ...
      return(
        <div style={{backgroundColor: "rgb(230,230,230)", minHeight: "110vh"}}>
            ...
            <div className="row d-flex justify-content-evenly">
                ...
                <Link to={`/movies/${this.state.suggestions[0].id}`} style={{ color: "black", textDecoration: "none"}}>
                ...
                <div className="col-10 col-md-4 col-lg-3">
                <Link to={`/movies/${this.state.suggestions[1].id}`} style={{ color: "black", textDecoration: "none"}}>
                <div className="row d-flex justify-content-center">
                    <div style={{width: "80%"}}>
                        <div className="card mt-3 mb-3" style={{border: "solid", borderColor: "violet", boxShadow: "2px 2px 2px 1px rgba(200,0,200,0.3)"}}>
                ...
                <div className="col-10 col-md-4 col-lg-3">
                <Link to={`/movies/${this.state.suggestions[2].id}`} style={{ color: "black", textDecoration: "none"}}>
                <div className="row d-flex justify-content-center">
                    <div style={{width: "80%"}}>
                        <div className="card mt-3 mb-3" style={{border: "solid", borderColor: "violet", boxShadow: "2px 2px 2px 1px rgba(200,0,200,0.3)"}}>
