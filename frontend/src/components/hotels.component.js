...
class Hotels extends React.Component{
    ...
    getSuggestions(){
        axios.get(`http://127.0.0.1:8000/hotels/suggestions`)
        .then(res => {
            this.setState({
    ...
    render(){
      return(
        <div style={{backgroundColor: "rgb(230,230,230)", minHeight: "110vh"}}>
            {this.state.searched && <Navigate to={`/hotels/search/${this.state.searchWord}`}></Navigate>}
            <div className="row d-flex justify-content-evenly align-items-center">
                <div className="col-10 col-md-9 col-lg-8 mt-2 mb-2 pt-1 pb-1">
                    <form className="d-flex" style={{width: "100%"}} onSubmit={this.search}>
                        <input className="form-control me-2" type="search" placeholder="Enter City Name" aria-label="SearchRestaurantHotel" onChange={(e) => {this.setState({searchWord: e.target.value})}}/>
            ...
            <div className="row d-flex justify-content-evenly">
                ...
                <Link to={`/hotels/${this.state.suggestions[0].id}`} style={{ color: "black", textDecoration: "none"}}>
                <div className="row d-flex justify-content-center">
                    <div style={{width: "80%"}}>
                        <div className="card mt-3 mb-3" style={{border: "solid", borderColor: "violet", boxShadow: "2px 2px 2px 1px rgba(200,0,200,0.3)"}}>
                            <img src={this.state.suggestions[0].imgurl} className="card-img-top" alt="..." />
                ...
                <div className="col-10 col-md-4 col-lg-3">
                <Link to={`/hotels/${this.state.suggestions[1].id}`} style={{ color: "black", textDecoration: "none"}}>
                <div className="row d-flex justify-content-center">
                    <div style={{width: "80%"}}>
                        <div className="card mt-3 mb-3" style={{border: "solid", borderColor: "violet", boxShadow: "2px 2px 2px 1px rgba(200,0,200,0.3)"}}>
                            <img src={this.state.suggestions[1].imgurl} className="card-img-top" alt="..." />
                            <div className="card-body">
                ...
                <div className="col-10 col-md-4 col-lg-3">
                <Link to={`/hotels/${this.state.suggestions[2].id}`} style={{ color: "black", textDecoration: "none"}}>
                <div className="row d-flex justify-content-center">
                    <div style={{width: "80%"}}>
                        <div className="card mt-3 mb-3" style={{border: "solid", borderColor: "violet", boxShadow: "2px 2px 2px 1px rgba(200,0,200,0.3)"}}>
                            <img src={this.state.suggestions[2].imgurl} className="card-img-top" alt="..." />
                            <div className="card-body">
