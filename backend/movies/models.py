...
class Movie(models.Model):
    ...
    def caststr(self): 
        castlist = self.cast.replace("<Person id:", "")
        castlist = castlist.replace("]", "")
        castlist = castlist.replace("[http name:_", "")
        castlist = castlist.replace("_>", "")
        castlist = castlist.replace("[", "")
        castlist = re.sub(r'[0-9]','',castlist)
        return castlist
        print(castlist)
    ...
    def directorstr(self) : 
        castlist = self.directors.replace("<Person id:", "")
        castlist = castlist.replace("]", "")
        castlist = castlist.replace("[http name:_", "")
        castlist = castlist.replace("_>", "")
        castlist = castlist.replace("[", "")
